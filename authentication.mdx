...
1. **Sign up** at [https://parking.lapscher.com/auth/signup](https://parking.lapscher.com/auth/signup)
2. **Verify your email** using the confirmation link
3. **Wait for admin approval** - contact your building administrator
4. **Log in** at [https://parking.lapscher.com/auth/login](https://parking.lapscher.com/auth/login)
